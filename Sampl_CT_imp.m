function varargout = Sampl_CT_imp(varargin)
% SAMPL_CT_IMP MATLAB code for Sampl_CT_imp.fig
%      SAMPL_CT_IMP, by itself, creates a new SAMPL_CT_IMP or raises the existing
%      singleton*.
%
%      H = SAMPL_CT_IMP returns the handle to a new SAMPL_CT_IMP or the handle to
%      the existing singleton*.
%
%      SAMPL_CT_IMP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SAMPL_CT_IMP.M with the given input arguments.
%
%      SAMPL_CT_IMP('Property','Value',...) creates a new SAMPL_CT_IMP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Sampl_CT_imp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Sampl_CT_imp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Sampl_CT_imp

% Last Modified by GUIDE v2.5 27-Jun-2015 20:57:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Sampl_CT_imp_OpeningFcn, ...
                   'gui_OutputFcn',  @Sampl_CT_imp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Sampl_CT_imp is made visible.
function Sampl_CT_imp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Sampl_CT_imp (see VARARGIN)

% Choose default command line output for Sampl_CT_imp
...
% UIWAIT makes Sampl_CT_imp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Sampl_CT_imp_OutputFcn(hObject, eventdata, handles) 
...
try
[y,x,p] = ct_imp_plot_private(x0,xl,xr,co,0);
