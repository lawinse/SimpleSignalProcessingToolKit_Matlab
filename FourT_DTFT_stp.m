function varargout = FourT_DTFT_stp(varargin)
% FOURT_DTFT_STP MATLAB code for FourT_DTFT_stp.fig
%      FOURT_DTFT_STP, by itself, creates a new FOURT_DTFT_STP or raises the existing
%      singleton*.
%
%      H = FOURT_DTFT_STP returns the handle to a new FOURT_DTFT_STP or the handle to
%      the existing singleton*.
%
%      FOURT_DTFT_STP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FOURT_DTFT_STP.M with the given input arguments.
%
%      FOURT_DTFT_STP('Property','Value',...) creates a new FOURT_DTFT_STP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FourT_DTFT_stp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FourT_DTFT_stp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help FourT_DTFT_stp

% Last Modified by GUIDE v2.5 29-Jun-2015 21:03:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @FourT_DTFT_stp_OpeningFcn, ...
                   'gui_OutputFcn',  @FourT_DTFT_stp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before FourT_DTFT_stp is made visible.
function FourT_DTFT_stp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FourT_DTFT_stp (see VARARGIN)

% Choose default command line output for FourT_DTFT_stp
...
% UIWAIT makes FourT_DTFT_stp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FourT_DTFT_stp_OutputFcn(hObject, eventdata, handles) 
