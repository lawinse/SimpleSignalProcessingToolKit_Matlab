function varargout = Sampl_CT_Rec(varargin)
% SAMPL_CT_REC MATLAB code for Sampl_CT_Rec.fig
%      SAMPL_CT_REC, by itself, creates a new SAMPL_CT_REC or raises the existing
%      singleton*.
%
%      H = SAMPL_CT_REC returns the handle to a new SAMPL_CT_REC or the handle to
%      the existing singleton*.
%
%      SAMPL_CT_REC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SAMPL_CT_REC.M with the given input arguments.
%
%      SAMPL_CT_REC('Property','Value',...) creates a new SAMPL_CT_REC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Sampl_CT_Rec_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Sampl_CT_Rec_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Sampl_CT_Rec

% Last Modified by GUIDE v2.5 03-Jul-2015 00:42:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Sampl_CT_Rec_OpeningFcn, ...
                   'gui_OutputFcn',  @Sampl_CT_Rec_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Sampl_CT_Rec is made visible.
function Sampl_CT_Rec_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Sampl_CT_Rec (see VARARGIN)

% Choose default command line output for Sampl_CT_Rec
...
% UIWAIT makes Sampl_CT_Rec wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Sampl_CT_Rec_OutputFcn(hObject, eventdata, handles) 
...
try
[y,x,p] = ct_Rec_plot_private( x0,x1,xl,xr,co,0);
...
%        eval(get(hObject,'String')) returns contents of inputX1 as a double
...
set(handles.inputX1, 'String', handles.metricdata.x1);
