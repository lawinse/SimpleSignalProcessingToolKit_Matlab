function varargout = DT_Convoltion(varargin)
% DT_CONVOLTION MATLAB code for DT_Convoltion.fig
%      DT_CONVOLTION, by itself, creates a new DT_CONVOLTION or raises the existing
%      singleton*.
%
%      H = DT_CONVOLTION returns the handle to a new DT_CONVOLTION or the handle to
%      the existing singleton*.
%
%      DT_CONVOLTION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DT_CONVOLTION.M with the given input arguments.
%
%      DT_CONVOLTION('Property','Value',...) creates a new DT_CONVOLTION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DT_Convoltion_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DT_Convoltion_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DT_Convoltion

% Last Modified by GUIDE v2.5 28-Jun-2015 14:35:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DT_Convoltion_OpeningFcn, ...
                   'gui_OutputFcn',  @DT_Convoltion_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DT_Convoltion is made visible.
function DT_Convoltion_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DT_Convoltion (see VARARGIN)

% Choose default command line output for DT_Convoltion
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DT_Convoltion wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DT_Convoltion_OutputFcn(hObject, eventdata, handles) 
...
switch(handles.data.type1)
    case 1
        [y1, x1] = dt_imp_plot(handles.data.b1, handles.data.l1, handles.data.r1, handles.data.co1,0);
    case 2
        [y1, x1] = dt_step_plot(handles.data.b1, handles.data.l1, handles.data.r1, handles.data.co1, handles.data.a1,0);
    case 3
        [y1, x1] = dt_Sa_plot(handles.data.b1, handles.data.l1, handles.data.r1, handles.data.a1,0);
    case 4
        [y1, x1] = dt_Rec_plot(handles.data.tb1,  handles.data.b1,handles.data.l1, handles.data.r1, handles.data.co1,0);
    case 5
        [y1, x1] = dt_exp_plot(handles.data.co1, handles.data.a1, handles.data.b1, handles.data.l1, handles.data.r1,0,0);
end
switch(handles.data.type2)
    case 1
        [y2, x2] = dt_imp_plot(handles.data.b2, handles.data.l2, handles.data.r2, handles.data.co2,0);
    case 2
        [y2, x2] = dt_step_plot(handles.data.b2, handles.data.l2, handles.data.r2, handles.data.co2, handles.data.a2,0);
    case 3
        [y2, x2] = dt_Sa_plot(handles.data.b2, handles.data.l2, handles.data.r2, handles.data.a2,0);
    case 4
        [y2, x2] = dt_Rec_plot(handles.data.b2, handles.data.tb2, handles.data.l2, handles.data.r2, handles.data.co2,0);
    case 5
        [y2, x2] = dt_exp_plot(handles.data.co2, handles.data.a2, handles.data.b2, handles.data.l2, handles.data.r2,0,0);
end
%figure(1);
try
[f, k] = dt_conv(y1,y2,x1,x2);
catch 
...
switch (val)
    ...
    case 5
        ...
        set(handles.Ctext2,'Visible','off');
        set(handles.tb1,'Visible','off');
        set(handles.Ctext3,'String','*(');
        set(handles.Ctext4,'String','+');
        set(handles.Ctext5,'String','j)^n*u[n]');
        set(handles.a1,'Visible','on');
...
switch (val)
    ...
    case 4
        ...
        type2 = 4;
     case 5
        set(handles.Ctext6,'String','*(');
        set(handles.a2,'Visible','on');
        set(handles.Ctext7,'String','+');
        set(handles.Ctext8,'String','j)^n*u[n]');
        set(handles.tb2,'Visible','off');
        set(handles.Ctext9,'Visible','off');
        type2 = 5;
end
...
%        eval(get(hObject,'String')) returns contents of a1 as a double
